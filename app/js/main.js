...
$script([ '/components/jquery/jquery.min.js', '/components/leaflet/leaflet.js', '/components/angular/angular.js' ], function() {
    $script('/components/d3/d3.v2.min.js', function() {
        $script([
  	    '/components/leaflet.zoomfs/leaflet.zoomfs.js',
  	    '/js/controllers/discover.js',
  	    '/js/directives/leaflet.js',
  	    '/js/directives/flag.js',
        ], function() {
