...
$script('/components/jquery/jquery.min.js', function() {
    $script([ '/components/leaflet/leaflet.js',
	      '/components/angular/angular.js',
	      '/components/underscore/underscore-min.js',
	      '/components/d3/d3.v2.min.js' ], function() {
        $script([ '/components/leaflet.zoomfs/leaflet.zoomfs.js',
  	          '/js/controllers/discover.js',
  	          '/js/controllers/play.js',
  	          '/js/directives/leaflet.js',
  	          '/js/directives/flag.js' ], function() {
